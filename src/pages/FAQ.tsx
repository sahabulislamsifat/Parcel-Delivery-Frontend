      ...
      <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <Item title="How do I track my shipment?">
            Go to the “Track Parcel” page and enter your tracking ID. You’ll get
            real-time updates on your parcel’s current location and estimated
            delivery time.
          </Item>
          ...
          <Item title="What should I do if my parcel is delayed or lost?">
            You can contact our support team directly through the “Support” page
            or email us at{" "}
            <span className="text-[#009CFE] font-medium">
