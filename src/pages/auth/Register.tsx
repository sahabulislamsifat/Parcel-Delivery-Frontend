    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="w-6/12 mx-auto flex flex-col justify-center p-6 md:p-12 bg-white">
        ...
        <button
          ...
          className="w-full cursor-pointer flex items-center justify-center gap-2 py-3 border border-gray-300 rounded hover:bg-gray-100 transition-colors"
        >
          <FaGoogle />
      ...
      <div className="hidden lg:block relative">
        <img
          src="https://static.vecteezy.com/system/resources/previews/004/557/108/non_2x/courier-deliver-goods-to-people-using-truck-with-city-as-background-free-vector.jpg"
          alt="Register"
